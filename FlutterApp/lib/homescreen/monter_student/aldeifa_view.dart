...
import 'package:gradproject/sakn%20details/supervisor_details_of_building_/build_recognized/diafa_recognized.dart';
...
class AldeifaView extends StatefulWidget {
  const AldeifaView({super.key});

  @override
  State<AldeifaView> createState() => _AldeifaViewState();
}

class _AldeifaViewState extends State<AldeifaView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: provider.isDark()
      ...
      appBar: AppBar(
        ...
        title: Center(child: Text( AppLocalizations.of(context)!.diafa)),
        leading: IconButton(
      ...
      body: Column(
        children: [
          SizedBox(height: 150,),
          Available_Recognized(firstPage:DiafaAvaliableRoom(), secondPage: diafaRecognized())
        ],
      ),
    );
  }
