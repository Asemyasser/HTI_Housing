...
import 'package:gradproject/student_screen/bus_times_female.dart';
import 'package:provider/provider.dart';
import '../../AppTheme.dart';
import '../../excelFile.dart';
import '../../navigationBar/navigationSuperviser.dart';
import '../../notification/supervisor.dart';
import '../../sakn details/supervisor_details_of_building_/build_recognized/al62_recognized.dart';
...
class Al62 extends StatefulWidget {
  const Al62({super.key});

  @override
  State<Al62> createState() => _Al62State();
}

class _Al62State extends State<Al62> {
  int _currentIndex = 0;
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Text(
                      AppLocalizations.of(context)!.al62_building,
                      style: provider.isDark()
                ...
                Available_Recognized(
                    firstPage: Al62AvaliableRoom(),
                    secondPage: Al62Recognized()),
                SizedBox(
                  height: 50,
                ),
                Container(
