...
import 'package:gradproject/profile-screens/screens/help-center-page.dart';
...
class FemaleProfileStudent extends StatelessWidget {
  const FemaleProfileStudent({super.key});
          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _buildMenuItem(context, 'assets/image/profile/call.svg', AppLocalizations.of(context)!.helpCenter, HelpCenterPage(),iconSize: 16.0,),
