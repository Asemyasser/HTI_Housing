...
class AljabartiRecognized extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            buildFloorSection(AppLocalizations.of(context)!.first_floor, studentsFourthFloor),
            buildFloorSection(AppLocalizations.of(context)!.second_floor, studentsFourthFloor),
            buildFloorSection(AppLocalizations.of(context)!.third_floor, studentsFourthFloor),
            buildFloorSection(AppLocalizations.of(context)!.fourth_floor, studentsFourthFloor),
            buildFloorSection(AppLocalizations.of(context)!.fifth_floor, studentsFifthFloor),
          ],
        ),
      ),
    );
