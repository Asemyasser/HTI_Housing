...
class BusTimeFemale extends StatelessWidget {
  const BusTimeFemale({super.key});
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            ), // يمكنك استخدام صورة للحافلة
            //  SizedBox(height: 20),

            _buildBusCard(
                context,
                AppLocalizations.of(context)!.busLocationAlSafwa,
                AppLocalizations.of(context)!.time1,
                AppLocalizations.of(context)!.time2,
                AppLocalizations.of(context)!.time3),
            _buildBusCard(
                context,
                AppLocalizations.of(context)!.busLocationAl62,
