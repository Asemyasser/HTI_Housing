...
//////// comment on import complete dataaaaa
class Delayallowance extends StatelessWidget {
  @override
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    rowbuildInputField(
                        AppLocalizations.of(context)!.sunday, context),
                    rowbuildInputField(
                        AppLocalizations.of(context)!.monday, context),
                    rowbuildInputField(
                        AppLocalizations.of(context)!.friday, context),
                  ],
                ),
              ),
              ...
              CompleteData(
                ...
                buttonColor2: provider.isDark() ? MyTheme.kohli : Colors.white,
  ...
  Widget rowbuildInputField(String hint, context) {
    var provider = Provider.of<SettingProvider>(context);
    return Padding(
